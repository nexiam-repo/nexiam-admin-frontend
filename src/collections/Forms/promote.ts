...
export const Promote: CollectionConfig = {
	slug: "contact-promote",
	hooks: {
		afterChange: [sendContactFormEmail, createSupportNotificationHook("Promote Form")],
	},
	labels: {
		singular: "Form - Promote",
		plural: "Form - Promote",
	},
	admin: {
		useAsTitle: "email",
		defaultColumns: ["fullName", "companyName", "email", "createdAt"],
		description: "Promote form submissions from the landing page",
		group: "Landing Page",
	},
	access: {
	...
	fields: [
		{
			...
			required: true,
			label: "Full Name",
			minLength: 3, // Matches Schema min(3)
			maxLength: 100,
			access: {
		...
		},
		{
			...
			options: [
				...
				// Legacy options for backward compatibility (DB migration fix)
